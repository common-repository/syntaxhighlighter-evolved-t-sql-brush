...
SyntaxHighlighter.brushes.TSQL = function()
{
    ...
    var geshiKeywords3 = 'sp_ActiveDirectory_Obj sp_ActiveDirectory_SCP ' +
        ...
        // geshi
        {   regex: new RegExp(this.getKeywords(geshiKeywords1), 'gmi'),   css: 'tsql1'},
        {   regex: new RegExp(this.getKeywords(geshiKeywords2), 'gmi'),   css: 'tsql2'},
        {   regex: new RegExp(this.getKeywords(geshiKeywords3), 'gmi'),   css: 'tsql3'},
    ];
};
